...
SELECT create_distributed_table('bmsql_district', 'd_w_id',colocate_with => 'bmsql_warehouse');
...
SELECT create_distributed_table('bmsql_oorder', 'o_w_id',colocate_with => 'bmsql_warehouse');
...
SELECT create_distributed_table('bmsql_order_line', 'ol_w_id',colocate_with => 'bmsql_warehouse');
...
SELECT create_distributed_table('bmsql_stock', 's_w_id',colocate_with => 'bmsql_warehouse');
