...
/
-- desc:	query all the block by dba
-- usage:	@dba <RFILE#> <BLOCK#>
-- date:	2011-sep-06
col dba_object head object for a40 truncate
...
order by
	tch asc
/
-- desc:	query all the block by the latch(cache buffers chains) address
-- usage:	@dba4 <addr>
-- date:	2011-sep-06
col dba_object head object for a40 truncate
...
where
	bh.obj = o.data_object_id
and	o.data_object_id = &data_object_id
order by
	tch asc
/
