...
if [ "$DBTYPE" == "oracle" ] && [ "$SUBDBTYPE" == "dm" ];then
		...
		restore $BACKUPDIR/$FILENAME$BACKUPFLAG$BUSINTYPE TBBACKUPINFO TBRESTOREINFO TBSEQUENCE TBSCHEDULEAPPPROCESS TBSCHEDULEGROUP TBSCHEDULEJOB TBSCHEDULELOCK TBSCHEDULELOG TBSCHEDULEPAGE TBSCHEDULEPROCESS TBSCHEDULESMSSEND TBSCHEDULETASK TBSCHEDULETASKREGISTRY TBSCHEDULETRIGGER
...
echo "执行updateprocessstatu"
updateprocessstatus $BACKUPMODE
echo "执行updateprocessstatu end"
#使用示例   
