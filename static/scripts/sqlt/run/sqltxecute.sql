SPO sqltxecute.log;
@@sqltcommon1.sql
REM $Header: 215187.1 sqltxecute.sql 12.1.06 2014/01/30 carlos.sierra mauro.pagano $
REM
...
REM   # cd sqlt
REM   # sqlplus apps
REM   SQL> START [path]sqltxecute.sql [path]scriptname
REM   SQL> START run/sqltxecute.sql input/sample/script1.sql
REM
REM NOTES
REM   1. For possible errors see sqltxecute.log and sqltxecute2.log.
...
PRO
PRO In case of a disconnect review sqltxecute2.log and ^^file_with_output.
PRO
